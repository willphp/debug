...
div#willphp_trace_title{background-color:#f0f1f3;height:35px;line-height:35px;padding: 0 12px;border-bottom:1px solid #ccc;border-top:1px solid #ccc;font-size:16px}
