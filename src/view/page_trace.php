...
div#willphp_trace_title{background-color:#f0f1f3;height:30px;padding: 3px 12px;border-bottom:1px solid #ccc;border-top:1px solid #ccc;font-size:16px}
div#willphp_trace_title span{color:#000;padding-right:12px;height:30px;line-height:30px;display:inline-block;margin-right:3px;cursor:pointer;font-weight:700}
...
div#willphp_trace_open{height:30px;float:right;text-align:right;overflow:hidden;position:fixed;bottom:0;right:0;line-height:30px;cursor:pointer}
